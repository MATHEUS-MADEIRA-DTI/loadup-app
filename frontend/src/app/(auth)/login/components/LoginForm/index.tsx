...
export default function LoginForm() {
  ...
  return (
    <StyledForm onSubmit={handleSubmit}>
      {login.error && (
        <StyledError>
          {login.error.message || strings.auth.errorGeneric}
        </StyledError>
      )}
      ...
      <StyledSubmitButton type="submit" disabled={login.isPending}>
        {login.isPending ? strings.common.loading : strings.auth.loginButton}
      </StyledSubmitButton>
    </StyledForm>
  );
}
